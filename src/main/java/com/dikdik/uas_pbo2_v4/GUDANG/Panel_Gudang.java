...
public class Panel_Gudang extends JPanel {
    private CardLayout cardLayout;
    private JPanel contentPanel;

    private JButton activeButton = null;

    public JButton btnDashboard, btnBahanBaku, btnLogout;

    public Panel_Gudang(String username) {
        ...
        btnDashboard = new JButton("Data Stok");
        btnBahanBaku = new JButton("Bahan Baku");

        JButton[] menuButtons = {btnDashboard, btnBahanBaku};
        ...
        contentPanel.add(new Logic_DataStok().getPanel(),  "Data Stok");
        contentPanel.add(panelWithText("Ini halaman Bahan Baku"), "Bahan Baku");
